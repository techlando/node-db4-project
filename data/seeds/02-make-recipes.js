...
const ingredients = [
    ...
    { ingredient_name: ' Chiken', ingredient_unit: 'kilos' },
...
const steps = [
    ...
    // salmon en Papillote
    { step_text: 'fish a salmon in tge Bidasoa river', step_number: 1, recipe_id: 3 },
    { step_text: 'Cook Salmon', step_number: 2, recipe_id: 3 },

]

const steps_ingredient = [
...
exports.seed = async function (knex) {
    ...
    await knex('steps_ingredients').insert(steps_ingredient)
}